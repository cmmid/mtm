...
In this course, we have 3 sessions (Wednesday and Friday) to enable you to think constructively about the type of model you might need for a research problem that we provide you with.
...
Wednesday's session (30 mins):

1.  Identify which group you are in and which modelling problem you should tackle (below)
...
Friday's session: You'll be working with colleagues in your group to sketch a model that answers your particular question. After this group work, there will be a session to discuss the problem you had to solve, and your ideas for a solution with the other groups. You and your group can write down your ideas on tldraw (link for each group given at the end of their problem).

## The problems

You will be assigned to one of the following three modelling problems.
...
| **GROUP** | **NAME** | **LINK** |
|-------------|   -----| ---------|
| A: SARS-CoV-2 | Damian B |  [A: SARS-CoV-2 Diagram Shared Sketchpad](https://www.tldraw.com/f/oXBpwBOlTflMKvp6QzlTv?d=v0.0.1683.1248.page) |
|             | Claudia C | |
|             | Jim D | | 
| B: Dengue | Maria G | [B: Dengue Diagram Shared Sketchpad](https://www.tldraw.com/f/Dqy9P_xiI6WJ-TnieLDGG?d=v0.0.1683.1248.page) |
|             | Laura G | |
|             | Shaheer H | |
|             | Andree V | |
| C: Influenza (online)   |  Hwan H | [C: Flu Diagram Shared Sketchpad](https://www.tldraw.com/f/MdBR9UuUYyWSCISyfXLsh?d=v0.0.1683.1248.page) |
|             |  James K | |
|             |  Florence M | |
| D: SARS-CoV-2 (online) |  Leandro P | [D: SARS-CoV-2 Diagram Shared Sketchpad](https://www.tldraw.com/f/AE2dlUHQwPvmyBRUTodDj?d=v0.0.911.783.page)|
|             |  Olumuyiwa P | |
